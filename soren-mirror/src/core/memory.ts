...
export type MemoryRole = "USER" | "SOREN" | "SOREN-THOUGHTS" | "SYSTEM";
...
export class GlobalMemory {
  ...
  constructor(userId: string) {
    ...
    this.filePath = path.join(this.userBasePath, 'global_memory.md');
   ...
   */
  public appendInteraction(role: MemoryRole, content: string): void {
