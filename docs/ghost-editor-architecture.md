# Arquitectura del Agente: "Escritura"

## 1. Visión General
Este es una aplicación basada en Node.js. Su función es actuar como un "Segundo Cerebro" para el proceso de escritura, gestionando dos flujos de trabajo distintos:
1.  **Archivado de Contexto:** Guardar vivencias crudas sin juzgar.
2.  **Edición Literaria:** Criticar bocetos usando el contexto acumulado.

## 2. Estructura de Directorios
El proyecto se organiza para separar la *lógica* (código) de la *memoria* (datos persistentes).
...
└── 📂 src/                    # [CÓDIGO FUENTE]
    ...
    │   └── prompts.js         # Lógica de inyección de contexto (Guía vs. Ghost Writer).
    │
